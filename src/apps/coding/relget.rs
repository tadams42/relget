...
use crate::{App, AppAssets, AppBinary, AppVersion, ArchiveExtractor, Completion, RelgetClient, Shell};
...
impl Relget {
    pub const ID: &'static str = "relget";
    const OWNER: &'static str = "tadams42";
    const REPO: &'static str = "relget";
    const EXE_NAME: &'static str = "relget";
...
impl App for Relget {
    ...
    fn download(&self) -> Result<AppAssets> {
        ...
        let binary_data = extractor.extract_by_filename("relget")?;
