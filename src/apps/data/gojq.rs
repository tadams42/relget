...
impl App for GoJq {
    ...
    fn download(&self) -> Result<AppAssets> {
        ...
        let name = release.find_asset(|a| a.starts_with("gojq_") && a.ends_with("_linux_amd64.tar.gz"))?;
        ...
        Ok(AppAssets {
            ...
            completions: vec![Completion::zsh("gojq", extractor.extract_by_filename("_gojq")?)],
            ..Default::default()
        })
    }
}
