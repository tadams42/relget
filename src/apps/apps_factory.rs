...
use super::system::{Bottom, Btop, Duf, Dust, Dysk, Erdtree, Netwatch, Procs, Syswatch};
...
pub fn create_app(
    ...
    match id {
        ...
        Axe::ID => Some(Box::new(Axe::new(client))),
        ...
        Netwatch::ID => Some(Box::new(Netwatch::new(client))),
