...
impl Loggo {
    pub const ID: &'static str = "loggo";
    const OWNER: &'static str = "aurc";
    const REPO: &'static str = "loggo";
    const EXE_NAME: &'static str = "loggo";
...
impl App for Loggo {
    ...
    fn download(&self) -> Result<AppAssets> {
        ...
        let completions = gen_completions_subcommand("loggo", &binary_data, "completion")?;
        Ok(AppAssets {
