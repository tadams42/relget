...
- [agg](https://github.com/asciinema/agg) — Generate animated GIFs from asciinema session recordings
...
- [doggo](https://github.com/mr-karan/doggo) — Command-line DNS client for humans, inspired by dog
